...
Развёрнутое финансово-экономическое обоснование, сценарии развития и приоритетные клиентские ниши описаны в [BUSINESS_MODEL.md](/E:/neo-fin-ai/docs/BUSINESS_MODEL.md).
...
- при `TASK_RUNTIME=celery` стек включает отдельный worker и Redis для персистентного выполнения задач
